...
| `~/Library/Application Support/Headroom/headroom/logs/headroom-proxy---port-6868---*.log` | desktop capturing the managed backend's stdout | startup banner, bootstrap |
